...
const menuButton = {
                    ...
                    if(foucsStatus == "mergeAll"){
                        ...
                        for(let r = r1; r <= r2; r++){
                            for(let c = c1; c <= c2; c++){
                                ...
                                if(cell != null && (!isRealNull(cell.v) || cell.f != null || !!cell.dataConf) && !isfirst){
                                    fv = $.extend(true, {}, cell);
                                    isfirst = true;
                                }
    ...
    fontSelectList:[],
    defualtFont:["微软雅黑","宋体","黑体","楷体","仿宋","新宋体","华文新魏","华文行楷","华文隶书","Times New Roman","Arial","Tahoma","Verdana","京东朗正体","京东正黑体"],
